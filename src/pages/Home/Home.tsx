    ...
    <div className="home-container">
      ...
      <section className="section-container">
        <div>
          <h3>Who I Am</h3>
          <p>
            Hi, I'm a professional web developer with over 8 years of experience
            crafting digital experiences that make a difference. I'm passionate
            about turning complex problems into elegant, user-friendly solutions
          </p>
        </div>
        <div>
          <h3>What I Do</h3>
        ...
        <div>
          ...
          <p>
            ...
            something meaningful that not only meets technical requirements but
